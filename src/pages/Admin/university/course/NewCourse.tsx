...
const NewCourse = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (create && await create.then((res) => res?.status) === 201) {
            ...
            navigate(`/admin/university/course/${id}/details`);
        }
        setIsCreating(false);
    }
                            ...
                            <form className="form-horizontal" id="createRoleForm" onSubmit={handleSubmit}>
                                <div className="card-body">
                                    <div className="form-group row">
                                        <label htmlFor="name" className="col-sm-2 col-form-label">Course Name <span className="text-danger">*</span></label>
                                    ...
                                    <div className="form-group row mt-4">
                                        ...
                                        <div className="col-sm-10 d-flex">
                                            ...
                                            <button type="reset" className="btn btn-default float-right" onClick={() => navigate("/admin/university/course")}>Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
