...
const Home = () => {
    ...
    const images = [
        ...
        "/dist/img/course-img/3213968.jpg",
        "/dist/img/course-img/3158033.jpg",
        "/dist/img/course-img/3139066.jpg",
    ];
    ...
    useEffect(() => {
        const fetchAndSetUserDetails = async () => {
            try {
                ...
                const listModule = await getModulesByCourseIdForStudent(userDetails.id);
                                    ...
                                    <div className="card card-primary card-outline">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <h5 className="card-title">
                                                <Link className="text-dark" to={`/student/${module.id}/materials`}>
